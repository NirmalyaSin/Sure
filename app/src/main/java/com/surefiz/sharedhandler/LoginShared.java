...
public class LoginShared {
    ...
    public static void setRegistrationResponse(String s) {
        ...
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(SharedUtils.KEY_SHARED_SCALE_USER_ID, s);
        editor.commit();
    }
    ...
    public static String getRegistrationResponse(Context context) {
        ...
        if (LoginShared.context == null || LoginShared.prefs == null)
            activateShared(context);
        res = prefs.getString(SharedUtils.KEY_SHARED_SCALE_USER_ID, "");
        return res;
    }
    /**
...
//wifi config-varification
    ...
    public static void setAccessToken(Context context, String value) {
        ...
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(SharedUtils.KEY_SHARED_ACCESS_TOKEN_KEY, value);
        editor.commit();
    }
    ...
    public static String getAccessToken(Context context) {
        if (LoginShared.context == null || LoginShared.prefs == null)
            activateShared(context);
        return prefs.getString(SharedUtils.KEY_SHARED_ACCESS_TOKEN_KEY, SharedUtils.KEY_SHARED_NO_DATA);
    }
