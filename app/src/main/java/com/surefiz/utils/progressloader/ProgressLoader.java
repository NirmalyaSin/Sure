...
public class ProgressLoader {
     ...
     */
    public static ProgressLoader create(Context context) {
        return new ProgressLoader(context);
    }

    /**
     * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code ProgressLoader.create(Context context)}).
     *
     * @param context Activity context that the HUD bound to
     * @param style   One of the ProgressLoader.Style values
     * @return An unique HUD instance
     */
    public static ProgressLoader create(Context context, Style style) {
        return new ProgressLoader(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public ProgressLoader setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressLoader setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressLoader setLabel(String label) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public ProgressLoader setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public ProgressLoader setAutoDismiss(boolean isAutoDismiss) {
        mIsAutoDismiss = isAutoDismiss;
        return this;
    }

    public ProgressLoader show() {
        if (!isShowing()) {
